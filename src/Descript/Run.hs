...
-- | Parse the input code, run the Descript executable at the given path, print its output, and return the result.
...
-- | Parse the input (second arg), run the Descript executable (first arg), and print its output (third path, defaults to input path with output extension).
